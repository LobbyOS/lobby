lobby.app = $.extend(lobby.app, {
  ...
  startExam: function(){
    ...
    $(".exam .toggleGroup:first").addClass("active");
  ...
  events: function(){
    $(".exam .toggleQuestion").live("click", function(){
      ...
      qid = $(this).data("id");
      if(type == "note"){
        lobby.app.loadQuestion(type, qid, $(".exam .toggleGroup.active").data("id"));
      }else{
    ...
    $(".exam .toggleGroup").live("click", function(){
      if(typeof $(this).attr("disabled") == "undefined"){
        $(".exam .toggleGroup").removeClass('active');
    ...
    $(".exam #note-box .options .option").live("click", function(event){
       ...
       */
      $(".exam #note-box .toggleGroup").not(".active").attr("disabled", true);
      $(".exam #note-box .toggleGroup.active").addClass("green");
    });
  ...
  practical: function(){
     ...
     * Disable other tabs
     */
    $(".exam .examTabs").remove();
    
    $(".exam #practical-box .groups .tab").live("click", function(){
    ...
    $(".exam #practical-box .choices li").live("click", function(){
      group_id = $("#practical-box .groups li.active").data("id");
    ...
    // Load 1st question
    $(".exam #practical-box .groups li:first").click();
  },
