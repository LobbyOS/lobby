    ...
    $.each(lobby.dash.tiles, function(type, items){
      if(type == "app" && typeof items == "object" && items.length != 0){
        $.each(items, function(i, data){
          var id = data['id'];
          var html = '<div class="app" id="'+ id +'" data-mode="none" data-initdelay="50"><a href="'+ lobby.url +'/app/'+ id +'"><div class="inner"><div class="image"><img src="'+ data['img'] +'" height="100%" width="100%"/></div><div class="title" style="color:black;">'+ data['name'] +'</div></div></a></div>';
